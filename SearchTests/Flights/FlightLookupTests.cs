...
public class FlightLookupTests
{
    ...
    [Test]
    public void ExpectedFlightsReturned_WhenFromLGWToAGPOnJulyFirst()
    {
        string from = "LGW";
        string to = "AGP";
        DateOnly date = new(2023, 7, 1);
        ...
        Assert.Multiple(() =>
        {
            Assert.That(flight_1.Id, Is.EqualTo(10), "Id not equal");
            ...
            Assert.That(flight_1.Price, Is.EqualTo(225), "Price not equal");
        ...
        Assert.Multiple(() =>
        {
            Assert.That(flight_2.Id, Is.EqualTo(11), "Id not equal");
            ...
            Assert.That(flight_2.Price, Is.EqualTo(155), "Price not equal");
